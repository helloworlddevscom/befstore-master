...
class EDD_PDF_Invoice extends TCPDF {
	...
	public function Header() {
		...
		if ( isset( $edd_options['eddpdfi_header_message'] ) ) {
			...
			$eddpdfi_header = str_replace( '{date}', date_i18n( get_option('date_format'), strtotime( $eddpdfi_payment->date ) ), $eddpdfi_header );
	...
	public function Footer() {
		...
		if ( isset( $edd_options['eddpdfi_footer_message'] ) ) {
			...
			$eddpdfi_footer = str_replace( '{date}', date( get_option('date_format'), strtotime( $eddpdfi_payment->date ) ), $eddpdfi_footer );
