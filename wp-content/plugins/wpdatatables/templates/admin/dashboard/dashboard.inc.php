                ...
                <div class="card wdt-changelog-card">
                    ...
                    <div class="card-body card-padding">
                        ...
                        <div class="alert alert-info m-b-0" role="alert">
                            ...
                            <ul>
                                <li> <?php _e('<strong>Improvement:</strong> Added warning message on system info when LibXML version is lower then 2.7.7.', 'wpdatatables'); ?></li>
                                ...
                                <li> <?php _e('<strong>BugFix:</strong> Fixed issue with button strings in edit modal for different skins.', 'wpdatatables'); ?></li>
                                ...
                                <li> <?php _e('<strong>BugFix:</strong> Fixed error message on welcome page.', 'wpdatatables'); ?></li>
                                <li> <?php _e('<strong>BugFix:</strong> Fixed issue with showing quotes in charts.', 'wpdatatables'); ?></li>
                                <li> <?php _e('<strong>BugFix:</strong> Fixed issue with showing all data in table when placeholders are empty and set as predefined filter value.', 'wpdatatables'); ?></li>
                                <li> <?php _e('<strong>BugFix:</strong> Fixed issue with conditional formatting for URL columns.', 'wpdatatables'); ?></li>
                                <li> <?php _e('<strong>BugFix:</strong> Fixed issue with saving data in Excel-like table with separate connection.', 'wpdatatables'); ?></li>
                                <li> <?php _e('<strong>BugFix:</strong> Fixed issue with translating strings in add-ons.', 'wpdatatables'); ?></li>
