 ...
 */
class HipChatHandler extends \GFPDF\Vendor\Monolog\Handler\SocketHandler
{
    /**
     * Use API version 1
     */
     ...
     */
    public function __construct($token, $room, $name = 'Monolog', $notify = \false, $level = \GFPDF\Vendor\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $format = 'text', $host = 'api.hipchat.com', $version = self::API_V1)
    {
    ...
    {
        switch (\true) {
            case $level >= \GFPDF\Vendor\Monolog\Logger::ERROR:
                return 'red';
            case $level >= \GFPDF\Vendor\Monolog\Logger::WARNING:
                return 'yellow';
            case $level >= \GFPDF\Vendor\Monolog\Logger::INFO:
                return 'green';
            case $level == \GFPDF\Vendor\Monolog\Logger::DEBUG:
                return 'gray';
            default:
                return 'yellow';
        }
