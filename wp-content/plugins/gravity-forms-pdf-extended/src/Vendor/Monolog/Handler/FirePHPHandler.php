...
use GFPDF\Vendor\Monolog\Formatter\WildfireFormatter;
/**
 * Simple FirePHP Handler (http://www.firephp.org/), which uses the Wildfire protocol.
 *
 * @author Eric Clemmons (@ericclemmons) <eric@uxdriven.com>
 */
class FirePHPHandler extends \GFPDF\Vendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
    ...
    {
        return new \GFPDF\Vendor\Monolog\Formatter\WildfireFormatter();
    }
    /**
