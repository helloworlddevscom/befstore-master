import { conversionFactor, emissionTypes, vehicleEmission } from '../constants';
...
export default function commuting(employees, miles) {
  ...
  const c2 = vehicleEmission.car.carbondioxide_kg_mile;
  const c3 = vehicleEmission.car.methane_g_mile;
  const c4 = vehicleEmission.car.nitriousoxide_g_mile;
