 ...
 *
 * @category            Plugin
 * @copyright           Copyright © 2020 Sandhills Development, LLC
 * @author              Sandhills Development, LLC
 * @package             CFM
 */
...
class EDD_Checkout_Fields_Manager {
	...
	public static function instance() {
		...
		if ( !isset( self::$instance ) && !( self::$instance instanceof EDD_Checkout_Fields_Manager ) ) {
			...
			self::$instance->helper = self::$instance->load_abstracts();
	...
	public function define_globals() {
		...
		if ( !defined( 'cfm_plugin_version' ) ) {
			define( 'cfm_plugin_version', '2.1.8' );
		}
		// Plugin Root File
	...
	public function setup() {
		...
		if ( class_exists( 'EDD_License' ) ) {
			$license = new EDD_License( __FILE__, cfm_plugin_name, cfm_plugin_version, 'Sandhills Development, LLC', null, null, 161667 );
		}
	}
...
add_action( 'plugins_loaded', 'EDD_CFM', 11 );
