...
// Note that the eddCfmGrecaptchaOnloadCallback is called when google reCaptcha is loaded by passing it when enqueueing reCaptcha.
// See https://developers.google.com/recaptcha/docs/display
if( cfm_form.recaptcha ) {
		var eddCfmGrecaptchaOnloadCallback = function() {
			var cfm_recaptcha_element = document.getElementById( 'cfm-recaptcha' );
			if ( cfm_recaptcha_element ) {
				grecaptcha.render( 'cfm-recaptcha', {
					sitekey: cfm_form.sitekey
				} );
			}

			// Listen for gateway changes and re-render.
