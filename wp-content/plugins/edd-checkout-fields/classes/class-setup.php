	...
	public function enqueue_scripts( $override = false ) {
		...
		if ( edd_is_checkout() || $override ) {
			...
			if ( ! empty( $public_key ) && ! empty( $private_key ) ) {
				...
				wp_enqueue_script( 'recaptcha', 'https://www.google.com/recaptcha/api.js?onload=eddCfmGrecaptchaOnloadCallback&render=explicit', array( 'jquery', 'cfm_form' ), cfm_plugin_version, true );
