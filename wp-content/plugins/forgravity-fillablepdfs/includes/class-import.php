...
class Import {
	...
	private static function display_upgrade_message() {
		...
		<div class="fillablepdfs-import__upgrade">
			...
			<img src="<?php echo fg_fillablepdfs()->get_base_url(); ?>/images/features/import.svg" alt="<?php esc_html_e('Upgrade to Import', 'forgravity_fillablepdfs' ); ?>" width="114" />
			...
			<span class="fillablepdfs-import__upgrade-message">
				...
				<p><?php esc_html_e( 'With the Professional License, you can upload up to 50 templates. Plus, you get the extremely powerful Convert PDFs into Gravity Forms extension!', 'forgravity_fillablepdfs' ); ?></p>
