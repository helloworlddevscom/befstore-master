...
class Feed_Template extends Hidden {
	...
	public function scripts() {
		...
		$scripts[] = [
			...
			'src'       => fg_fillablepdfs()->get_base_url() . "/js/feed_template{$min}.js",
			'version'   => $min ? fg_fillablepdfs()->get_version() : filemtime( fg_fillablepdfs()->get_base_path() . '/js/feed_template.js' ),
		...
		wp_localize_script(
			...
			[
				...
				'templates'    => [
					...
					'placeholder' => fg_fillablepdfs()->get_base_url() . '/images/templates/placeholder.svg',
	...
	public function styles() {
		...
		return [
			[
				...
				'src'     => fg_fillablepdfs()->get_base_url() . "/css/feed_template{$min}.css",
				'version' => $min ? fg_fillablepdfs()->get_version() : filemtime( fg_fillablepdfs()->get_base_path() . '/css/feed_template.css' ),
				'enqueue' => [
					[
	 ...
	 * @since 3.0
	 */
	public function ajax_get_nested_form() {
